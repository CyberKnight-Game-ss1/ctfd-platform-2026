...
# ============================================================
# count = 0 khi use_rds = false (phương án A: DB container trên VM1) → không tạo RDS,
# không trả ~$15/tháng cho resource không dùng. Bật lại bằng use_rds = true.
...
resource "aws_ssm_parameter" "db_url" {
  ...
  type  = "SecureString"
  value = "postgresql://ctfd:${var.db_password}@${aws_db_instance.ctf_postgres[0].endpoint}/ctfd"
